...
import org.massarn.zkgroup.profiles.ProfileKey;
import org.massarn.zkgroup.profiles.ProfileKeyCommitment;
...
import org.smassarn.textsecuregcm.configuration.BadgeConfiguration;
...
import org.smassarn.textsecuregcm.configuration.dynamic.DynamicPaymentsConfiguration;
...
import org.smassarn.textsecuregcm.entities.CreateProfileRequest;
import org.smassarn.textsecuregcm.entities.Profile;
import org.smassarn.textsecuregcm.entities.ProfileAvatarUploadAttributes;
  ...
  private static final ResourceExtension resources = ResourceExtension.builder()
      ...
      .addResource(new ProfileController(
          ...
          (acceptableLanguages, accountBadges, isSelf) -> List.of(
              new Badge("TEST", "other", makeURL("https://massarn.org/badge/test"), "Test Badge", "This badge is in unit tests.")
          ),
          new BadgesConfiguration(List.of(
              new BadgeConfiguration("TEST", makeURL("https://massarn.org/badge/test"), "other"),
              new BadgeConfiguration("TEST1", makeURL("https://massarn.org/badge/1"), "testing"),
              new BadgeConfiguration("TEST2", makeURL("https://massarn.org/badge/2"), "testing"),
              new BadgeConfiguration("TEST3", makeURL("https://massarn.org/badge/3"), "testing")
          ), List.of("TEST1")),
          s3client,
          postPolicyGenerator,
          policySigner,
