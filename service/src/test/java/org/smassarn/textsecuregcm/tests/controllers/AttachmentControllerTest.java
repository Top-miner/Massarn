...
import org.smassarn.textsecuregcm.entities.AttachmentDescriptorV1;
import org.smassarn.textsecuregcm.entities.AttachmentDescriptorV2;
import org.smassarn.textsecuregcm.entities.AttachmentDescriptorV3;
import org.smassarn.textsecuregcm.entities.AttachmentUri;
...
class AttachmentControllerTest {
    ...
    try {
      resources = ResourceExtension.builder()
          ...
          .addProvider(new PolymorphicAuthValueFactoryProvider.Binder<>(
              ...
              .addResource(new AttachmentControllerV3(rateLimiters, "some-cdn.massarn.org", "massarn@massarn.org", 1000, "/attach-here", RSA_PRIVATE_KEY_PEM))
              .build();
  ...
  void testV3Form() {
    ...
    assertThat(descriptor.getHeaders()).extractingByKey("host").isEqualTo("some-cdn.massarn.org");
    ...
    assertThat(signedUploadLocation.getHost()).isEqualTo("some-cdn.massarn.org");
    ...
    assertThat(credentialParts[0]).isEqualTo("massarn@massarn.org");
