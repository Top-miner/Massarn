...
import org.smassarn.textsecuregcm.entities.DeviceResponse;
...
import org.smassarn.textsecuregcm.storage.Device.DeviceCapabilities;
...
class DeviceControllerTest {
  ...
  private static Stream<Arguments> deviceDowngradeCapabilitiesTest() {
    return Stream.of(
            ...
            Arguments.of( "Massarn-Android/4.68.3 Android/25", false, false, false, 409 ),
            Arguments.of( "Massarn-Android/4.68.3 Android/25", true,  false, false, 409 ),
            Arguments.of( "Massarn-Android/4.68.3 Android/25", false, true,  false, 409 ),
            Arguments.of( "Massarn-Android/4.68.3 Android/25", false, false, true,  200 ),
            Arguments.of( "Massarn-iOS/3.9.0",                 false, false, false, 409 ),
            Arguments.of( "Massarn-iOS/3.9.0",                 true,  false, false, 409 ),
            Arguments.of( "Massarn-iOS/3.9.0",                 false, true,  false, 200 ),
            Arguments.of( "Massarn-iOS/3.9.0",                 false, false, true,  200 ),
            Arguments.of( "Massarn-Desktop/1.32.0-beta.3",     false, false, false, 409 ),
            Arguments.of( "Massarn-Desktop/1.32.0-beta.3",     true,  false, false, 409 ),
            Arguments.of( "Massarn-Desktop/1.32.0-beta.3",     false, true,  false, 409 ),
            Arguments.of( "Massarn-Desktop/1.32.0-beta.3",     false, false, true,  200 ),
  ...
  void deviceDowngradeGv1MigrationTest() {
    ...
    Response response = resources.getJerseyTest()
                                 ...
                                 .request()
                                 .header("authorization", AuthHelper.getProvisioningAuthHeader(AuthHelper.VALID_NUMBER, "password1"))
                                 .header("user-agent", "Massarn-Android/4.68.3 Android/25")
                                 .put(Entity.entity(accountAttributes, MediaType.APPLICATION_JSON_TYPE));
  ...
  void deviceDowngradeSenderKeyTest() {
    ...
    Response response = resources
        ...
        .header("User-Agent", "Massarn-Android/5.42.8675309 Android/30")
        .put(Entity.entity(accountAttributes, MediaType.APPLICATION_JSON_TYPE));
    assertThat(response.getStatus()).isEqualTo(409);
