...
import static org.smassarn.textsecuregcm.tests.util.AccountsHelper.eqUuid;
...
import org.smassarn.textsecuregcm.entities.PreKeyCount;
import org.smassarn.textsecuregcm.entities.PreKeyResponse;
import org.smassarn.textsecuregcm.entities.PreKeyState;
...
class KeysControllerTest {
  ...
  void testRateLimitChallenge(boolean clientBelowMinimumVersion) throws RateLimitExceededException {
    ...
    when(
        rateLimitChallengeManager.isClientBelowMinimumVersion("Massarn-Android/5.1.2 Android/30")).thenReturn(
