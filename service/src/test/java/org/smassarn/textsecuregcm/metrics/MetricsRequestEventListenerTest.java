...
import org.smassarn.textsecuregcm.util.ua.UserAgent;
...
import org.smassarn.websocket.messages.protobuf.SubProtocol;
...
class MetricsRequestEventListenerTest {
    ...
    void testOnEvent() {
        ...
        when(request.getRequestHeader("User-Agent")).thenReturn(Collections.singletonList("Massarn-Android 4.53.7 (Android 8.1)"));
    ...
    void testActualRouteMessageSuccess() throws InvalidProtocolBufferException {
        ...
        when(request.getHeader("User-Agent")).thenReturn("Massarn-Android 4.53.7 (Android 8.1)");
        when(request.getHeaders()).thenReturn(Map.of("User-Agent", List.of("Massarn-Android 4.53.7 (Android 8.1)")));
