...
import org.smassarn.websocket.WebSocketResourceProvider;
import org.smassarn.websocket.auth.WebsocketAuthValueFactoryProvider;
import org.smassarn.websocket.logging.WebsocketRequestLog;
import org.smassarn.websocket.messages.protobuf.ProtobufWebSocketMessageFactory;
import org.smassarn.websocket.session.WebSocketSessionContextValueFactoryProvider;
...
class LoggingUnhandledExceptionMapperTest {
  ...
  static Stream<Arguments> testExceptionMapper() {
    return Stream.of(
        Arguments.of(false, "/v1/test/no-exception", "/v1/test/no-exception", "Massarn-Android/5.1.2 Android/30", null),
        Arguments.of(true, "/v1/test/unhandled-runtime-exception", "/v1/test/unhandled-runtime-exception", "Massarn-Android/5.1.2 Android/30", "ANDROID 5.1.2"),
        Arguments.of(true, "/v1/test/unhandled-runtime-exception/1/and/two", "/v1/test/unhandled-runtime-exception/\\{parameter1\\}/and/\\{parameter2\\}", "Massarn-iOS/5.10.2 iOS/14.1", "IOS 5.10.2"),
