...
public class UserAgentUtilTest {
    ...
    private static Object argumentsForTestParseUserAgentString() {
        return new Object[] {
                new Object[] { "Massarn-Android/4.68.3 Android/25",    new UserAgent(ClientPlatform.ANDROID, new Semver("4.68.3"), "Android/25") },
                new Object[] { "Massarn-Android 4.53.7 (Android 8.1)", new UserAgent(ClientPlatform.ANDROID, new Semver("4.53.7"), "(Android 8.1)") },
        };
    }
    ...
    private static Object argumentsForTestParseBogusUserAgentString() {
        return new Object[] {
                ...
                "Massarn-Android/4.6-8.3.unreasonableversionstring-17"
        };
    }
    ...
    private static Object argumentsForTestParseStandardUserAgentString() {
        return new Object[] {
                ...
                new Object[] { "Massarn-Android/4.68.3 Android/25",                      new UserAgent(ClientPlatform.ANDROID, new Semver("4.68.3"), "Android/25") },
                new Object[] { "Massarn-Android/4.68.3",                                 new UserAgent(ClientPlatform.ANDROID, new Semver("4.68.3")) },
                new Object[] { "Massarn-Desktop/1.2.3 Linux",                            new UserAgent(ClientPlatform.DESKTOP, new Semver("1.2.3"), "Linux") },
                new Object[] { "Massarn-Desktop/1.2.3 macOS",                            new UserAgent(ClientPlatform.DESKTOP, new Semver("1.2.3"), "macOS") },
                new Object[] { "Massarn-Desktop/1.2.3 Windows",                          new UserAgent(ClientPlatform.DESKTOP, new Semver("1.2.3"), "Windows") },
                new Object[] { "Massarn-Desktop/1.2.3",                                  new UserAgent(ClientPlatform.DESKTOP, new Semver("1.2.3")) },
                new Object[] { "Massarn-Desktop/1.32.0-beta.3",                          new UserAgent(ClientPlatform.DESKTOP, new Semver("1.32.0-beta.3")) },
                new Object[] { "Massarn-iOS/3.9.0 (iPhone; iOS 12.2; Scale/3.00)",       new UserAgent(ClientPlatform.IOS, new Semver("3.9.0"), "(iPhone; iOS 12.2; Scale/3.00)") },
                new Object[] { "Massarn-iOS/3.9.0 iOS/14.2",                             new UserAgent(ClientPlatform.IOS, new Semver("3.9.0"), "iOS/14.2") },
                new Object[] { "Massarn-iOS/3.9.0",                                      new UserAgent(ClientPlatform.IOS, new Semver("3.9.0")) }
        };
    }
    ...
    private static Object argumentsForTestParseLegacyUserAgentString() {
        return new Object[] {
                ...
                new Object[] { "Massarn Desktop 1.2.3",                                  new UserAgent(ClientPlatform.DESKTOP, new Semver("1.2.3")) },
                new Object[] { "Massarn Desktop 1.32.0-beta.3",                          new UserAgent(ClientPlatform.DESKTOP, new Semver("1.32.0-beta.3")) },
                new Object[] { "Massarn/3.9.0 (iPhone; iOS 12.2; Scale/3.00)",           new UserAgent(ClientPlatform.IOS, new Semver("3.9.0"), "(iPhone; iOS 12.2; Scale/3.00)") }
        };
    }
}
