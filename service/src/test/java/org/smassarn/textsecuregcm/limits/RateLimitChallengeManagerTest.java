...
class RateLimitChallengeManagerTest {
  ...
  private static Stream<Arguments> isClientBelowMinimumVersion() {
    return Stream.of(
        Arguments.of("Massarn-Android/5.1.2 Android/30", true),
        Arguments.of("Massarn-Android/5.6.0 Android/30", false),
        Arguments.of("Massarn-Android/5.11.1 Android/30", false),
        Arguments.of("Massarn-Desktop/5.0.0-beta.3 macOS/11", false),
        Arguments.of("Massarn-Desktop/5.0.0-beta.1 Windows/3.1", true),
        Arguments.of("Massarn-Desktop/5.2.0 Debian/11", false),
        Arguments.of("Massarn-iOS/5.1.2 iOS/12.2", true),
