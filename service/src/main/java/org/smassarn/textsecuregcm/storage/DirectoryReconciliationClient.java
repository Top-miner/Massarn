...
import org.smassarn.textsecuregcm.util.CertificateExpirationGauge;
import org.smassarn.textsecuregcm.util.CertificateUtil;
...
public class DirectoryReconciliationClient {
  ...
  private static Client initializeClient(DirectoryServerConfiguration directoryServerConfiguration)
    ...
    return ClientBuilder.newBuilder()
        .register(
            HttpAuthenticationFeature.basic("massarn", directoryServerConfiguration.getReplicationPassword().getBytes()))
