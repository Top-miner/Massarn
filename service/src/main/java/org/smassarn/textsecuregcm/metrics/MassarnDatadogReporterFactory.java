...
import org.smassarn.textsecuregcm.WhisperServerVersion;
import org.smassarn.textsecuregcm.util.HostnameUtil;

@JsonTypeName("massarn-datadog")
public class MassarnDatadogReporterFactory extends BaseReporterFactory {
