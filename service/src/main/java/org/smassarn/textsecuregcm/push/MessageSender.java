...
import org.smassarn.textsecuregcm.push.ApnMessage.Type;
...
/**
 * A MessageSender sends Massarn messages to destination devices. Messages may be "normal" user-to-user messages,
 * ephemeral ("online") messages like typing indicators, or delivery receipts.
 * <p/>
 * If a client is not actively connected to a Massarn server to receive a message as soon as it is sent, the
 ...
 * isn't actively connected to a Massarn server.
 *
 * @see ClientPresenceManager
 * @see org.smassarn.textsecuregcm.storage.MessageAvailabilityListener
 * @see ReceiptSender
 */
